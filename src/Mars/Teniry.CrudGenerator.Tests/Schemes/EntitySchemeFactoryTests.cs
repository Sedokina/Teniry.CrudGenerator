...
namespace Teniry.CrudGenerator.Tests.Schemes;
...
public class EntitySchemeFactoryTests {
    ...
    public void Should_ExtractEntityNamespaceAndAssembly() {
        // Arrange
        _internalEntityGeneratorConfiguration.ClassMetadata.ContainingNamespace = "Teniry.CrudGenerator.Tests";
        ...
        // Assert
        actual.EntityNamespace.Should().Be("Teniry.CrudGenerator.Tests");
