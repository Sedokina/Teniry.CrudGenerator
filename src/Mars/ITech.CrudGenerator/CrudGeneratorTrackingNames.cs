...
internal class CrudGeneratorTrackingNames {
    ...
    public const string TransformConfigurationsAndDbContexts = nameof(TransformConfigurationsAndDbContexts);
    public const string CreateGeneratorRunners = nameof(CreateGeneratorRunners);
}