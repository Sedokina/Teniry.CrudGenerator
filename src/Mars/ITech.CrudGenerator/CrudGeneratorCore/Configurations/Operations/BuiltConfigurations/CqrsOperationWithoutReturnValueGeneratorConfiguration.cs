...
internal class CqrsOperationWithoutReturnValueGeneratorConfiguration
{
    ...
    {
        GlobalConfiguration = new GlobalCqrsGeneratorConfiguration(
            autogeneratedFileText: globalConfiguration.AutogeneratedFileText,
            nullableEnable: globalConfiguration.NullableEnable
        );
        Generate = generate;
