...
namespace Teniry.CrudGenerator.TestApiTests.E2eTests.Core;

public static class AssemblyAssertionsExtensions {
    public static AndConstraint<AssemblyAssertions> ContainType(
        this AssemblyAssertions parent,
        string typeName,
        string because = "",
        ...
        Execute.Assertion
            ...
            .FailWith(
                "Expected {context:directory} to contain {0}{reason}, but found {1}.",
                _ => typeName,
    ...
    [CustomAssertion]
    public static AndConstraint<AssemblyAssertions> NotContainType(
        this AssemblyAssertions parent,
        string typeName,
        string because = "",
        params object[] becauseArgs
        ...
        Execute.Assertion
            ...
            .FailWith(
                "Expected {context:directory} not to contain {0}{reason}, but found {1}.",
                _ => typeName,
    ...
    [CustomAssertion]
    public static AndConstraint<AssemblyAssertions> BeInNamespaceThatEndsWith(
        this AssemblyAssertions parent,
        string typeName,
        string endsWith,
        string because = "",
        ...
        Execute.Assertion
            ...
            .FailWith(
                "Expected {context:directory} type {0} namespace end with {1}{reason}, but found {2}.",
                _ => typeName,
                _ => endsWith,
