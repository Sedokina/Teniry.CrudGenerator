...
{
    public static CqrsWithReturnValueConfiguration Construct(GlobalCrudGeneratorConfiguration globalConfiguration)
    {
...
{
    public static CqrsConfiguration Construct(GlobalCrudGeneratorConfiguration globalConfiguration)
    {
...
{
    public static CqrsListConfiguration Construct(GlobalCrudGeneratorConfiguration globalConfiguration)
    {
        return new()
        {
            GlobalConfiguration = globalConfiguration,
...
public sealed class GlobalCrudGeneratorConfiguration
{
...
{
    public GlobalCrudGeneratorConfiguration GlobalConfiguration { get; set; }
